...
var matrixA = [], matrixB = [], answer =[], A = [], B = [];
class GauseScidelIteration extends Component {
    constructor(props) {
        super(props)
        this.state = {
            row: 0,
            ...
            <div>
                ...
                <div style={{ paddingLeft: 100, paddingRight: 100 }} >
                    <Form onChange={this.handleChange}>
                        <input name="row" defaultValue='0' className="form-control" placeholder="A row"></input>
                        <input name="collum" defaultValue='0'  className="form-control" placeholder="A collum"></input>
...
export default GauseScidelIteration;